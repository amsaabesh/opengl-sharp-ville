...
void orangeFall()
{
    glColor3ub(255,102,0);//falling orange color
    Orange();
    glPushMatrix();
...
void boat(float x1, float y1, float boatLength)
{
    ...
    glBegin(GL_POLYGON);
        glColor3d(1,0,0);
         glColor3ub(255, 28, 22);//noukar tolani
        glVertex2d(x1,y1);
        glVertex2d(x2,y2);
        glVertex2d(x3,y3);
        glVertex2d(x4,y4);
    ...
    glBegin(GL_POLYGON);
        ...
        glColor3ub(160, 155, 136);//noukar upor
        glVertex2d(x3,y3);
        glVertex2d(x4,y4);
        glVertex2d(x5,y5);
        glVertex2d(x6,y6);
...
void river()
{
    glColor3ub(0, 204, 255);//color change to indigo from dark blue
...
void sky()
{
    ...
    glColor3ub(255, 106, 0);//sun color
    circle(4,10,75,80);//width, height, pos from left, pos from bottom
    //cloud left to right
    glColor3f(1, 1, 1);
